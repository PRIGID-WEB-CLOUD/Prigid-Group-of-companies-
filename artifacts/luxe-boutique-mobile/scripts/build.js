...
function findWorkspaceRoot(startDir) {
  ...
  throw new Error("Could not find workspace root (no workspace file found)");
}
...
function getDeploymentDomain() {
  ...
  if (process.env.VITE_PUBLIC_DOMAIN) {
    return stripProtocol(process.env.VITE_PUBLIC_DOMAIN);
  }
